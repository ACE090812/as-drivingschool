...
-- ──────────────────────────────────────────────────────────────────────────────
--  QB-TARGET ZONE  (adjust coords/heading to your DVLA location)
-- ──────────────────────────────────────────────────────────────────────────────

local DVLA_COORDS  = vector3(214.98, -1398.74, 30.58)
local DVLA_SIZE_X  = 1.5
local DVLA_SIZE_Y  = 1.5
local DVLA_HEADING = 0.0

CreateThread(function()
    exports['qb-target']:AddBoxZone('dvla_portal', DVLA_COORDS, DVLA_SIZE_X, DVLA_SIZE_Y, {
        name      = 'dvla_portal',
        heading   = DVLA_HEADING,
        debugPoly = false,
        minZ      = DVLA_COORDS.z - 1.0,
        maxZ      = DVLA_COORDS.z + 2.0,
    }, {
        options = { {
            type  = 'client',
